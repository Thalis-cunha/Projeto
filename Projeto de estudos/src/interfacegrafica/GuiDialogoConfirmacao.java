...
public class GuiDialogoConfirmacao extends JPanel {
    ...
    private void inicializarComponentes() {
        ...
        radioButton2.setBounds(55, 30, 200, 25);
    ...
    private void definirEventos() {
        btMostrar.addActionListener(new ActionListener() {
            ...
            if (radioButton1.isSelected()) {
                resp = JOptionPane.showConfirmDialog(null, "Erro ao acessar arquivo." + "Tentar novamente?", "Erro de arquivo", 
                JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE);
            }else if (radioButton2.isSelected()) {
                resp = JOptionPane.showConfirmDialog(null, "Deseja salvar as alteracoes?", "Salvar o arquivo", 
